...
namespace BaGet.Core.Services
{
    ...
    public interface IPackageStorageService
    {
        ...
        Task<Stream> GetPackageStreamAsync(PackageIdentity id);
        ...
        Task<Stream> GetNuspecStreamAsync(PackageIdentity id);
        ...
        Task<Stream> GetReadmeStreamAsync(PackageIdentity id);
        ...
        /// <param name="version">The package's version.</param>
        /// <returns></returns>
        Task DeleteAsync(PackageIdentity id);
    }
}
