...
namespace BaGet.Core.Services
{
    ...
    public interface IPackageService
    {
        ...
        Task<Package> FindOrNullAsync(PackageIdentity pid, bool includeUnlisted = false, bool includeDependencies = false);
        ...
        Task<bool> ExistsAsync(PackageIdentity pid);
        ...
        Task<bool> UnlistPackageAsync(PackageIdentity pid);
        ...
        /// <returns>False if the package does not exist.</returns>
        Task<bool> RelistPackageAsync(PackageIdentity pid);
        /// <summary>
        ...
        /// <returns>False if the package does not exist.</returns>
        Task<bool> IncrementDownloadCountAsync(PackageIdentity pid);
        ...
        Task<bool> HardDeletePackageAsync(PackageIdentity pid);
    }
}
