...
namespace LiGet.Tests
{
    public class UrlExtensionsTest
    {
        ...
        public UrlExtensionsTest() {
            ...
            requestMock.SetupGet(x => x.Host).Returns(new HostString("localhost",9011));
