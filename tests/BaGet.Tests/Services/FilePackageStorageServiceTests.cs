    ...
    public class FilePackageStorageServiceTests
    {
        ...
        public class GetPackageStreamAsync : FactsBase
        {
            ...
            public async Task ThrowsIfDoesntExist()
            {
                ...
                await Assert.ThrowsAsync<DirectoryNotFoundException>(() => 
                    _target.GetPackageStreamAsync(Identity));
            }
            ...
            public async Task GetsStream()
            {
                ...
                // Act
                var result = await _target.GetPackageStreamAsync(Identity);
        ...
        public class GetNuspecStreamAsync : FactsBase
        {
            ...
            public async Task ThrowsIfDoesntExist()
            {
                ...
                await Assert.ThrowsAsync<DirectoryNotFoundException>(() =>
                    _target.GetNuspecStreamAsync(Identity));
            }
            ...
            public async Task GetsStream()
            {
                ...
                // Act
                var result = await _target.GetNuspecStreamAsync(Identity);
        ...
        public class GetReadmeStreamAsync : FactsBase
        {
            ...
            public async Task GetsStream()
            {
                ...
                // Act
                var result = await _target.GetReadmeStreamAsync(Identity);
        ...
        public class DeleteAsync : FactsBase
        {
            ...
            {
                await _target.DeleteAsync(Identity);
            }
        ...
        public class FactsBase : IDisposable
        {
            ...
            protected PackageIdentity Identity => new PackageIdentity(_package.Id, _package.Version);
